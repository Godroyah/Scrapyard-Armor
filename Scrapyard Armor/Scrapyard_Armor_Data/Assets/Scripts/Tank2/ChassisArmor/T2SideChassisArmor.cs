...
public class T2SideChassisArmor : MonoBehaviour {
	...
	void OnTriggerEnter2D (Collider2D other)
	{
		if (other.tag == "T1Shell") 
		{
			...
			//	Destroy (other.gameObject);
			//	Debug.Log ("Penetration on Side Chassis!", this.gameObject);
			//}
		//else if (T1penetrationScript.Penetration <= lineOfSightArmor) {
				//Destroy (other.gameObject);
				//Debug.Log ("Shot Bounced on Side Chassis!", this.gameObject);
				//}
			}
		}
