...
public class T1FrontChassisArmor : MonoBehaviour {
	...
	void Update ()
	{
        ...
        Debug.Log("TimetoArmorRecharge: " + TimetoArmorRecharge);
        Debug.Log("Time.time: " + Time.time);
        Debug.Log("nextArmorAdd: " + nextArmorAdd);
        if (Armor_Value < 0)
        {
